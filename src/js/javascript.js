...
let botaoDeClick = window.document.querySelector('btn-plataforma');
console.log(botaoDeClick)
...
/*const botao = document.querySelector(".btn-plataforma").value;
...
botao.addEventListener("click", () => {
    ...
    const botaoEstaAberto = elementoPlataformas.contains("ativo");


    if(botaoEstaAberto){ elementoPlataformas.classList.remove("ativo")
}else{ elementoPlataformas.classList.add("ativo")}
